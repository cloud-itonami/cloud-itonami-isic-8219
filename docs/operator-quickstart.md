# Operator Quickstart — Community Office Support Services Operations

Shortest path from clone to a verified local dry-run for **ISIC 8219** (`cloud-itonami-isic-8219`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8219.git
cd cloud-itonami-isic-8219
```
...
- Blueprint governor key: `office-support-governor`
- Likely source path: `src/**/office-support-governor.cljc`
